...
function UserCard({ELO,Coins,GlobalRank,Username}: {ELO:number,Coins:number,GlobalRank:number,Username:string}){
  return(
    <Card containerStyle={[GLOBAL_STYLES.card, {zIndex: 2}]}>
    <View style={styles.userRow}>
      <AvatarWithFlag country={COUNTRIES.JAPAN}/>
      <Text style={[GLOBAL_STYLES.headline,,{marginLeft: 16}]}>{Username}</Text>
    </View>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <UserCard Username='GubiGammer' ELO={1354} Coins={394} GlobalRank={39459} />
        <PuzzleCard />
