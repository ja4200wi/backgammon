...
import { View, TouchableOpacity, StyleSheet, Text, ActionSheetIOS, Alert} from 'react-native';
  ...
  return (
    <View style={styles.footerContainer}>
      <TouchableOpacity onPress={() => navigation.goBack()}>
        <Icon name="arrow-back" type="material" color={APP_COLORS.iconGrey} size={36} />
      </TouchableOpacity>
  ...
  onPress={() => 
    Alert.alert(
      ...
      [
        ...
        { text: 'Restart', onPress: () => console.log('Restart Pressed') }, 
      ],
      { cancelable: false }
    )
  }
  ...
  />
      ...
      <TouchableOpacity onPress={() => 
        ActionSheetIOS.showActionSheetWithOptions(
            {
                options: ['Cancel','Give up (-1)','Give up as a Gammon (-2)','Give up as a Backgammon (-3)'],
                cancelButtonIndex: 0,
      ...
      <TouchableOpacity onPress={() => console.log('double')}>
        <Text style={{fontSize: 30, color: APP_COLORS.iconGrey, fontWeight: '600'}}>x2</Text>
      </TouchableOpacity>
    </View>
  );
}
